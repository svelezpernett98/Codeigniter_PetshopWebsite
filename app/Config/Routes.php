...
$routes->get('/productos/perro/listado', 'Productos::productosPerro');
$routes->get('/productos/gato/listado', 'Productos::productosGato');
$routes->get('/productos/ave/listado', 'Productos::productosAve');
$routes->get('/productos/reptil/listado', 'Productos::productosReptil');
